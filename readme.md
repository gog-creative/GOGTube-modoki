...
注意：このソフトウェアは教育・研究目的で開発されており、使用する際には著作権法をはじめとした法律を厳守し、自己責任の上個人で使用してください。
## 主な特徴
...
- **多彩なダウンロードオプション**:
    ...
    - **直接再生機能**: ダウンロードを待たずに、Googleのサーバーから直接ストリーミング再生するオプションです。すぐに内容を確認したい場合に便利です。
...
（勝手にですが）参考にさせていただいたYouTubeMP3、そしてYouTubeMP3もどきの開発・運営されている方に感謝します。